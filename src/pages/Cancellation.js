...
function Cancellation() {
  ...
  <tbody>
    <tr className="align-top ">
      <td className="border border-collapse w-1/2 px-2 py-2">Up to 24 hours before start time of scheduled slot</td>
      <td className="border border-collapse w-1/2 px-2 py-2">No cancellation Fee. 100% refund back to source account</td>
    </tr>
    <tr className="align-top">
