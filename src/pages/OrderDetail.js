...
Bengaluru, Karnataka 560010, India</div>
        ...
        <div className='flex flex-col gap-4 lg:w-1/4 w-full '>
          ...
          <div className="w-full   bg-white flex flex-col lg:flex-row md:mx-1 p-5 md:p-2 rounded-xl shadow-lg ">
            <div className='flex flex-col w-full gap-2'>
          ...
          <div className="w-full   bg-white flex flex-col lg:flex-row md:mx-1 p-5 md:p-2 rounded-xl shadow-lg ">
            <div className='flex flex-col w-full gap-4'>
              ...
              <div className='border-2 rounded-lg flex flex-col gap-3 '>
                ...
                <div className='flex flex-row justify-start items-center w-full pl-3 py-3'>
            ...
            <div className='bg-white flex flex-col lg:flex-row md:mx-1 p-5 rounded-xl shadow-lg w-full  h-[260px] justify-center items-center'>
