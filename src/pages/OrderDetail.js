            ...
            <div className='text-[17px]' >Let's meet at the right place</div>
              ...
              <div className='border-2 rounded-lg flex flex-col gap-3 '>
                <div className='flex flex-row justify-start items-center w-full pl-3 pt-3'>
                  <div className='w-1/2 text-xs md:text-[17px] font-bold'>Meeting</div>
                  <div className='w-1/2 text-xs md:text-[17px]'>Ravi Anand</div>
                </div>
               
                <div className='border-t-2 rounded-lg w-full'></div>

              <div className='flex flex-row justify-start items-center w-full pl-3'>
                  <div className='w-1/2 text-xs md:text-[17px] font-bold'>Contact Number</div>
                  <div className='w-1/2 text-xs md:text-[17px]'>999 765 4321</div>
                </div>
                <div className='border-t-2 rounded-lg w-full'></div>
              
                
              <div className='flex flex-row justify-start items-center w-full pl-3'>
                  <div className='w-1/2 text-xs md:text-[17px] font-bold'>Date</div>
                  <div className='w-1/2 text-xs md:text-[17px]'>19 June 2019</div>
                </div>
                <div className='border-t-2 rounded-lg w-full'></div>

                
              <div className='flex flex-row justify-start items-center w-full pl-3'>
                  <div className='w-1/2 text-xs md:text-[17px] font-bold'>Time Slot</div>
                  <div className='w-1/2 text-xs md:text-[17px]'>05:00 P.M.</div>
                </div>
                <div className='border-t-2 rounded-lg w-full'></div>
              
                
              <div className='flex flex-row justify-start items-center w-full pl-3 pb-3'>
                  <div className='w-1/2 text-xs md:text-[17px] font-bold'>Address</div>
                  <div className='w-1/2 text-xs md:text-[17px]'>Navarang Theatre, 19th Main Road, Nagapura,
Bengaluru, Karnataka 560010, India</div>
                </div>
              ...
              <div className='w-full md:w-1/2 flex flex-col md:flex-row '>
                ...
                <div className='w-full md:w-1/2 flex flex-col gap-3 justify-center items-start  pt-3 md:pt-0'>
                      ...
                      <div className='text-xs md:text-[17px] font-bold'>Number</div>
                      <div className='text-[17px] '>+91-9642818941</div>
                </div>

              </div>
              <div onClick={()=>setBtn(!btn)} className='w-full flex flex-row justify-center items-center bg-[#FDE3D2] text-[#F47521] font-bold h-[48px] rounded-xl cursor-pointer' >Baggage Images<KeyboardArrowDownIcon /> </div>
          ...
          <div className='bg-white flex flex-col lg:flex-row md:mx-1 p-5 rounded-xl shadow-lg'>
            ...
            <div className='text-[17px]' >Let's deliver at the right place</div>
              ...
              <div className='flex flex-row justify-start items-center w-full pl-3'>
                  <div className='w-1/2 text-xs md:text-[17px] font-bold'>Departure Date</div>
                  <div className='w-1/2 text-xs md:text-[17px]'>19 June 2019</div>
                </div>
                <div className='border-t-2 rounded-lg w-full'></div>
              ...
              <div className='flex flex-row justify-start items-center w-full pl-3 pb-3'>
                  <div className='w-1/2 text-xs md:text-[17px] font-bold'>Time to meet Carter X</div>
                  <div className='w-1/2 text-xs md:text-[17px]'>05:00 P.M.</div>
                </div>
              ...
              <div onClick={() => setBtn1(!btn1)} className='w-full flex flex-row justify-center items-center bg-[#FDE3D2] text-[#F47521] font-bold h-[48px] rounded-xl cursor-pointer' >Baggage Images<KeyboardArrowDownIcon /> </div>
        ...
        <div className='flex flex-col gap-4 lg:w-1/4 w-full '>
            ...
            <div className='flex flex-col w-full gap-2'>
              ...
              <div className='flex flex-row gap-1 rounded-lg justify-start items-center w-full bg-[#1A7DC1] text-white p-2 rounded-b-none'>
                ...
                <div className='flex flex-row px-2 justify-start items-center w-full '>
                  <div className='w-1/2 text-[10px] '> <div className='font-bold'>Check in bag </div><div>Extra weight 5kg</div></div>
                ...
                <div className='border-t-2 rounded-lg w-full'></div>
                <div className='flex flex-row px-2 justify-start items-center w-full '>
                  <div className='w-1/2 text-[10px] '> <div className='font-bold'>Fragile</div></div>
                ...
                <div className='border-t-2 rounded-lg w-full'></div>
                <div className='flex flex-row px-2 justify-start items-center w-full '>
                  <div className='w-1/2 text-[10px] '> <div className='font-bold'>Gst</div><div>Extra weight 5kg</div></div>
          ...
          <div className="w-full min-w-[290px]  bg-white flex flex-col lg:flex-row md:mx-1 p-5 md:p-2 rounded-xl shadow-lg ">
            <div className='flex flex-col w-full gap-4'>
              <div className='text-xl  font-bold text-center'>Insurance Details</div>

              <div className='border-2 rounded-lg flex flex-col gap-3 '>
                <div className='flex flex-row justify-start items-center w-full pl-3 md:pl-2 pt-3'>
                <div className='w-1/2 text-[11px] '><div className='font-bold'>Total Value</div><div>*includes all charges
                            as applicable</div></div>
                  <div className='w-1/2 text-[11px] text-right'>₹ 313.95</div>
                </div>
                <div className='border-t-2 rounded-lg w-full'></div>
                <div className='flex flex-row justify-start items-center w-full pl-3 md:pl-2 pt-3'>
                <div className='w-1/2 text-[11px] font-bold'>Policy No.</div>
                  <div className='w-1/2 text-[11px] text-right'>2455/0009084/000/00</div>
                </div>
                <div className='border-t-2 rounded-lg w-full'></div>

                <div className='flex flex-row justify-start items-center w-full pl-3 md:pl-2 py-3'>
                <div className='w-1/2 text-[11px] font-bold'>Insurance Chain
                        Number</div>
                  <div className='w-1/2 text-[11px] text-right whitespace-nowrap '>90SDF908PHASDFHOI</div>
                </div>

              </div>
              
              <div className='text-xs font-bold text-center'>Standard Insurance <Button size='small'> <span className='text-[#1A7DC1]'>Terms & Conditions</span></Button></div>
