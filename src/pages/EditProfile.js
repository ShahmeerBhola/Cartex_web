        ...
        <div className='flex flex-col md:flex-row mx-auto w-10/12 md:w-11/12 gap-2 md:gap-2'>
            ...
            <div className='flex flex-col md:px-12 w-full gap-4'>
                      ...
                      <div className='rounded-lg border-[#CCCCCC]  border-2 w-full md:w-3/4 px-2'>
                          ...
                          <p className='font-bold text-2xl border-[#fff]' contentEditable={true}>Jane Doe</p>
                      </div>
              ...
              <p className='font-bold text-2xl' contentEditable={true}><span className='border-[1px] rounded-lg border-[#F47521] text-sm p-1 ' ><label className='text-[#F47521]' for="phonecode"><select  id="phonecode">
