        ...
        <div className="bg-none rounded-2xl px-3 py-2 lg:px-3 lg:py-3 shadow-xl">
            <div className="w-full ">
              <div className="flex flex-col gap-2">
                ...
                <div className={`border-2 rounded-lg  bg-white flex flex-row gap-2 w-full p-1 items-center ${step==1 && '!border-[#F47521]'}`}  onClick={()=>setToggle(!toggle)}>
                  <img src={Partner} />
                  <h3 className="font-bold text-xs">Alliance Partners</h3>
                  <img src={Group}  />
                  {
                   toggle &&  <div className="absolute rounded-xl top-20   w-[248px]  p-1 shadow-xl bg-white">
                ...
                <div className={`border-2 rounded-lg  bg-white flex flex-row gap-2 w-full p-1 items-center ${step==2 && '!border-[#F47521]'}`} onClick={()=>{setStep(2); navigate("localparcel")}}>
                  <img src={Parcel} />
                  <h3 className="font-bold text-xs">Local Parcels</h3>
                </div>{" "}
                <div className={`border-2 rounded-lg  bg-white flex flex-row gap-2 w-full p-1 items-center ${step==3 && '!border-[#F47521]'}`} onClick={()=>{setStep(3);navigate("cargotransfer")}}>
                  <img src={Transfer} />
                  <h3 className="font-bold text-xs">Cargo Transfers</h3>
                </div>{" "}
                <div className={`border-2 rounded-lg  bg-white flex flex-row gap-2 w-full p-1 items-center ${step==4 && '!border-[#F47521]'}`} onClick={()=>{setStep(4);navigate("citytransfer")}}>
                  <img src={City} />
                  <h3 className="font-bold text-xs">City Transfers</h3>
                </div>{" "}
                <div className={`relative border-2 rounded-lg  bg-white flex flex-row gap-2 w-full p-1 items-center ${step==5 && '!border-[#F47521]'}`} onClick={()=>{setStep(5);navigate("interterminal")}}>
                  <img src={Interterminal} />
                  <h3 className="font-bold w-1/2 text-xs">
                    Interterminal Transfers
                  </h3>
                  <h3 className="absolute right-3 top-1 rounded-full text-xs font-bold text-white bg-[#F47521] py-0.5 px-1">NEW!</h3>
                </div>
                <div className={`relative border-2 rounded-lg  bg-white flex flex-row gap-2 w-full p-1 items-center ${step==6 && '!border-[#F47521]'}`} onClick={()=>{setStep(6);navigate("olacarter")}}>
                  <img src={Ola} />
                  <h3 className="font-bold text-xs">
                    #olacarter
                  </h3>
            ...
            <div className="w-[230px] lg:w-[240px] flex">
              <div className="flex flex-col gap-2">
                ...
                <div className='relative border-2 cursor-pointer rounded-lg flex flex-row   w-[225px] px-1  py-1 items-center'  onClick={()=>setToggle(!toggle)}>
                  <img src={Partner} />
                  <h3 className="font-bold text-base text-center">Alliance Partners</h3>
