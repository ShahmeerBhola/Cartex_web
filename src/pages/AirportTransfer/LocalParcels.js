  ...
  return (
    ...
    <div className=" flex flex-col w-4/5 ">
              ...
              <div className="mt-3 flex flex-col gap-3 ">
                ...
                <h2 className='text-sm'>Fragile Charges will be applied for all electronics and TVs in original packing only.
</h2>
                <h2 className='text-sm'>All items need to be fully packed. Cargo forms will have to be filled additionally.</h2>
                </div>
                {/* agreement section */}
                <div className="mt-3 flex flex-row gap-2 ">
                ...
                <div className='my-3 flex flex-row gap-6'>
                  ...
                  <h3 className="text-sm font-bold text-[#1A7DC1]">Cargo Security Declaration</h3>
                </div>
                {/* Proceed */}
