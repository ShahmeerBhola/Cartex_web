    ...
    <div className=" flex flex-col md:w-4/5 w-full mt-4 px-2 ">
              ...
              <div className="mt-3 flex flex-col gap-3 ">
                <div className="rounded-lg border-[#CCCCCC] py-2 border-2  px-2 w-full lg:w-1/2">
                  ...
                  <div className="flex flex-row justify-between gap-1 pt-1">
                    <div className="flex flex-col gap-1 w-3/5">
                      <input type='text' placeholder='Enter Coupon Code' className='outline-0 text-xl lg:text-2xl font-baseline'/>
                ...
                <div className='my-3 flex flex-row gap-2 lg:gap-6'>
                  <h3 className="text-xs lg:text-sm font-bold text-[#1A7DC1]">Departure Booking Information</h3>
                  <h3 className="text-xs lg:text-sm font-bold text-[#1A7DC1]">Cancellation And Refund Policy</h3>
                ...
                <div className='flex flex-col lg:flex-row justify-between mt-2'>
                  ...
                  <div className="text-xs lg:text-[15px] text-[#F47521] font-bold">
                    ...
                    <h2 className="font-bold text-lg lg:text-2xl" >30 Oct 2021 before 10:00 AM</h2>
                  </div>
