    ...
    <Modal titleimage={cartex} heading="Create a new account" >
      <div className='flex flex-col gap-2 md:gap-4'>
          ...
          <div className='rounded-lg border-[#CCCCCC]  border-2  px-2 w-[250px] md:w-[352px]'>
            ...
            <p className='font-bold text:lg md:text-2xl border-[#fff] text-[#707070]' contentEditable={true}>Enter Name</p>
        </div>     
        ...
        <div className='rounded-lg border-[#CCCCCC]  border-2 w-[250px] md:w-[352px] px-2 py-2'>
              ...
              <p className='font-bold text:lg md:text-2xl text-[#707070]' contentEditable={true}><span className='border-[1px] rounded-lg border-[#F47521] text-sm p-1 ' ><label className='text-[#F47521]' for="phonecode"><select  id="phonecode">
                <option value="+1">+1</option>
              
              </select></label></span> Enter Mobile No.</p>
                      </div>
                      ...
                      <div className='rounded-lg border-[#CCCCCC]  border-2  w-[250px] md:w-[352px] px-2'>
                          ...
                          <p className='font-bold text:lg md:text-2xl text-[#707070]' contentEditable={true}>Enter Email</p>
        </div>
